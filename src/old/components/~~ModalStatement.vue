    ...
    <div slot="body">
      <form @submit.prevent="onSubmit">
        ...
        <div class="form-item" :class="{ errorInput: $v.name.$error }">
          ...
          <p class="errorText" v-if="!$v.name.required"> Поле обязательно для заполнения! </p>
        ...
        <div class="form-item" :class="{ errorInput: $v.email.$error }">
          ...
          <p class="errorText" v-if="!$v.email.required"> Поле обязательно для заполнения! </p>
          <p class="errorText" v-if="!$v.email.email"> Email не корректный</p>
          <input
		        type="email"
        ...
        <div class="form-item" :class="{ errorInput: $v.phone.$error }">
          ...
          <p class="errorText" v-if="!$v.phone.required"> Заполните поле! </p>
  ...
  methods: {
    onSubmit () {
      ...
      if (!this.$v.$invalid) {
        ...
        console.log('modal vuelidate: ', user)
